...
public class DoctorSubscriber extends AsyncTask<String,String,String> {
    private static final String KEY_PARAM = "doctor_id";
    private final DoctorSubscriberCallback mCallback;
    private Context mContext;
    private String dataId;
    private String mToken;
    private ProgressDialog pd;

    public DoctorSubscriber(Context context, String dataId, DoctorSubscriberCallback callback) {
    ...
    public static interface DoctorSubscriberCallback {
